...
class _GeneratorPageState extends State<GeneratorPage>{
  ...
  Widget build(BuildContext context){
    ...
    return SafeArea(child: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Expanded(child: AnimatedList(scrollDirection: Axis.vertical ,
              reverse: true,
              key: keyy,
              ...
              itemBuilder: (_,index,animation){
                ...
                subtitle: appState.Icons.contains(appState.favicon[index])?
                Icon(appState.Icons[index],color: Colors.deepPurple,):
                Icon(appState.Icons[index],color: Colors.deepPurple)
                ),));
              },
              ),
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 10),
                ElevatedButton(onPressed:(){ appState.Icons.insert(0, icon);
